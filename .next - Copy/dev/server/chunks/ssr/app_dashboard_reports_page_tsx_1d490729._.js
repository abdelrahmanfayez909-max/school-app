...
function ReportsPage() {
    ...
    const generateAttendanceReport = async ()=>{
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html2pdf$2e$js$2f$dist$2f$html2pdf$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])().set(opt).from(element).save();
